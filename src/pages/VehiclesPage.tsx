    ...
    //     result = result.sort((a, b) => Number(a.is_assigned) - Number(b.is_assigned));
      ...
      useEffect(() => {
        const fetchVehicles = async () => {
          ...
          try {
            ...
            const sortedData = res.data.sort((a: Vehicle, b: Vehicle) =>
                Number(a.is_assigned) - Number(b.is_assigned)
              );
