...
//   const [loading, setLoading] = useState(true);
//   const [showModal, setShowModal] = useState(false);
//   const [vehiculeAModifier, setVehiculeAModifier] = useState<Vehicule | null>(
//     null
//   );
...
//           <button
//             onClick={() => setShowModal(true)}
//             className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-5 py-2 rounded-full shadow-md hover:shadow-lg transition"
//           >
//             <PlusCircle size={18} /> Ajouter un véhicule
//           </button>
//         </div>
...
//                     🛣️ <strong>Kilométrage :</strong>{" "}
//                     {v.kilometrage.toLocaleString()} km
//                   </p>
//                   <p className="text-sm text-gray-600">
//                     💰 <strong>Prix / jour :</strong> {v.prix_jour} MAD
//                   </p>
            ...
            {filteredVehicules.map((v) => (
              <div key={v.id} className="bg-white rounded-xl shadow hover:shadow-lg transition overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <p className="text-sm text-gray-600">🛣️ <strong>Kilométrage :</strong> {v.kilometrage.toLocaleString()} km</p>
